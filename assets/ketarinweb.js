(function () {
    ...
    function setupProgressPolling(tableEl) {
        ...
        function updateRow(app) {
            ...
            if (targetCell) {
                targetCell.textContent = app.update_mode === 'notify' ? t('table.just_notify') : ((app.target_type === 'folder' && app.current_target_path) ? app.current_target_path : (app.target_path || ''));
